...
CREATE TABLE "TEMPLATE" (
	...
	"CODE" VARCHAR2(2048) NOT NULL,
	CONSTRAINT "TEMPLATE_PK" PRIMARY KEY ("DIALECT_ID", "RULE_TYPE_ID") USING INDEX,
	FOREIGN KEY ("DIALECT_ID") REFERENCES "DIALECT" ("ID") ON DELETE CASCADE,
...
CREATE OR REPLACE VIEW "COMPARISONS" AS
	SELECT
		...
		col."NAME" AS "COLUMN"
	FROM "COMPARISON" com
		JOIN "COLUMN" col ON col."ID" = com."COLUMN_ID"
/
CREATE OR REPLACE VIEW "DATABASES" AS
	SELECT
		...
		dia."QUERY" AS "QUERY"
	FROM "DATABASE" db
		JOIN "DIALECT" dia ON dia."ID" = db."DIALECT_ID"
/
